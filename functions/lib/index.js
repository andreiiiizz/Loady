...
exports.testCheckPromoThresholds = exports.checkPromoThresholds = void 0;
exports.processPromoThresholdEvaluations = processPromoThresholdEvaluations;
 ...
 */
async function processPromoThresholdEvaluations() {
    ...
    try {
        ...
        for (const docSnap of simsSnapshot.docs) {
            const sim = { id: docSnap.id, ...docSnap.data() };
            if (!sim.expiry_date || sim.expiry_date === 'NO_EXPIRY')
                continue;
            ...
            for (const alert of pendingAlerts) {
                ...
                if (sim.device_id) {
                    ...
                    devSnap.forEach(tDoc => {
                        ...
                        if (tData.token && !tokens.includes(tData.token))
                            tokens.push(tData.token);
                    });
                }
 ...
 */
exports.checkPromoThresholds = (0, scheduler_1.onSchedule)({
 ...
 */
exports.testCheckPromoThresholds = (0, https_1.onRequest)({
    cors: true,
    memory: '256MiB'
}, async (req, res) => {
    try {
